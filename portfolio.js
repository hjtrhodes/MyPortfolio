...
export const projects = [
  {
    ...
    functionality: "Functionality: login, signup, image feed/upload, likes, comments, password security",
  ...
  },
  {
    ...
    functionality: "Functionality: login, signup, posts, newsfeed, profile page, likes, comments, search, navbar, image uploads",
  ...
  },
  {
    ...
    other: "",
    functionality: "Functionality: login, signup, sessions, user spaces, book a space with calendar, approve/reject a space",
  ...
  },
  {
    ...
    testing: "",
    other: "",
    functionality: "Functionality: game logic, win/loss conditional rendering, username display",
